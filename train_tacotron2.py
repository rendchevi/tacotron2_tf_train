...
from tensorflow_tts.models.tacotron2 import TFTacotronEmbeddings
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train/finetune Tacotron2 with reinitiated Embeddings"
    )
    parser.add_argument(
        "--train-dir",
        default=None,
    ...
    with STRATEGY.scope():
        ...
        new_embedding_layers = TFTacotronEmbeddings(tacotron_config, name='embeddings')
        tacotron2.embeddings = new_embedding_layers
